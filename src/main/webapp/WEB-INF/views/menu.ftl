        <div class="navbar navbar-expand-lg navbar-dark bg-dark" th:fragment="menu" ">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="subjects.ftl" >Tantárgyak</a>
                                <a class="dropdown-item" >Osztályok</a>
                                <a class="dropdown-item" >Diákok</a>
